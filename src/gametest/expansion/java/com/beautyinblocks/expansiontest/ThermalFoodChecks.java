...
final class ThermalFoodChecks {
    static void run(MinecraftServer server) {
        ...
        try {
            ...
            for (String id : List.of("pamhc2foodextended:strawberrysmoothieitem", "pamhc2foodextended:tomatosoupitem", "minecraft:rabbit_stew", "pamhc2foodextended:strawberrysmoothieitem")) {
        ...
        System.out.println("THERMAL CATALOG PASSED: " + catalog.size() + " foods; shared effect, reload, switches, exclusions, explicit and native overrides");
    }
